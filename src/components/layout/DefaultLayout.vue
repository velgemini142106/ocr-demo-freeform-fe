...
<template>
    <a-layout class="app-layout">
        <a-layout-sider collapsible breakpoint="xl">
          <a-space align="center" style="backgroundColor: var(--color-fill-2);">
            <div class="logo" style="text-align: center; justify-items: end; justify-content: center;" >
              <span>BSSD OCR</span>
            </div>
          </a-space>
        ...
        <a-layout>
            ...
            <a-layout style="padding: 0 24px">
                ...
                <a-layout-footer>© BSSD, 2023</a-layout-footer>
            </a-layout>
        </a-layout>
    </a-layout>
</template>
